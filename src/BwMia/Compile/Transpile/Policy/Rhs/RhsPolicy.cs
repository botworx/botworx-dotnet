...
{
    public class RhsPolicy : RootPolicy
    {
        public RhsPolicy()
        {
            //
            var visitTable = new[] {
                ...
                new NodeVisitInfo(AstNodeKind.SelectStmt, new SelectStmtVisit<Transpiler, SelectStmt>()),
                new NodeVisitInfo(AstNodeKind.CaseStmt, new CaseStmtVisit<Transpiler, CaseStmt>()),
